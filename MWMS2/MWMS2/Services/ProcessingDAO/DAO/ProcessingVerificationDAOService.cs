...
{
    public class ProcessingVerificationDAOService : BaseDAOService
    {
        private const string SearchVRF_q = @"   SELECT *
                                                FROM   (SELECT ( CASE
                                                               ...
                                                               P_get_item_code_by_record_id2(R.UUID) AS ITEMS
                                                        FROM   P_WF_INFO WI
                                                               JOIN P_WF_TASK WT
                                                               ...
                                                               JOIN P_MW_VERIFICATION V
                                                                 ON R.UUID = V.MW_RECORD_ID
                                                                    AND V.STATUS_CODE IN ( 'MW_VERT_STATUS_OPEN', 'MW_VERT_STATUS_ROLLBACK' )
