...
{
    public class ProcessingSEWSAService
    {
        private static string baseSql = "SELECT * FROM ";
        public void SubmissionsQ(Fn10RPT_SEWSAModel model)
        {
        ...
        public void Search(Fn10RPT_SEWSAModel model)
        {
            SubmissionsQ(model);
        ...
        public void Excel(Fn10RPT_SEWSAModel model)
        {
            SubmissionsQ(model);
           // if (string.IsNullOrEmpty(model.Day)) model.Day = "30";
            //model.QueryParameters.Add("dayDiff", model.Day);
