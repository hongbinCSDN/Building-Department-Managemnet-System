...
{
    public class Fn01LM_SignboardController : Controller
    {
        ...
        // GET: MWProcessing/Fn01LM_Signboard
        ...
        {
            return Content(JsonConvert.SerializeObject(BL.SearchSignboard(model), Formatting.Indented, new JsonSerializerSettings { ReferenceLoopHandling = ReferenceLoopHandling.Ignore }), "application/json");
        }
