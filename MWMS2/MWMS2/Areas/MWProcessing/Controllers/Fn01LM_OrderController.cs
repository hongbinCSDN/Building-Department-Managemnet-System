...
{
    public class Fn01LM_OrderController : Controller
    {
        ...
        {
            return Content(JsonConvert.SerializeObject(BL.SearchOrder(model), Formatting.Indented, new JsonSerializerSettings { ReferenceLoopHandling = ReferenceLoopHandling.Ignore }), "application/json");
        }
