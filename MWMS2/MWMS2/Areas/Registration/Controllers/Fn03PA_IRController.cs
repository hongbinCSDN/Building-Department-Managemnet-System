...
{
    public class Fn03PA_IRController : Controller
    {
        // GET: Registration/Fn03PA_IR
        ...
        {
            string type = RegistrationConstant.REGISTRATION_TYPE_IP;
        ...
        //    return Json(new { key = rs.ExportIR(model,type) });
        //}
        [HttpPost]
        public ActionResult Excel(InterviewResultSearchModel model)
        {
