...
{
    public class PEM1103AuditCheckPercentageController : Controller
    {
        ...
        public ActionResult PEM1103AuditCheckPercentage([Bind(Exclude = "")] PEM1103AuditCheckPercentageModel ACP)
        {
