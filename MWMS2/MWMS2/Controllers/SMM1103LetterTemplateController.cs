...
{
    public class SMM1103LetterTemplateController : Controller
    {
        private EntitiesSignboard db = new EntitiesSignboard();
        // GET: SMM1103LetterTemplate
        public ActionResult Index()
        {
            return View();
        }
        public ActionResult SMM1103LetterTemplate()
        {
        ...
        public ActionResult SMM1103LetterTemplateCreate()
        {
        ...
        public ActionResult SMM1103LetterTemplateCreate([Bind(Exclude = "")] B_S_LETTER_TEMPLATE lt, HttpPostedFileBase formFile)
        {
            if (formFile != null)
            {
                // string path = Server.MapPath("~/Uploads/");
                string path = @"C:/SMM\LetterTemplatePath\";
            ...
            lt.FILE_PATH = @"C:/SMM\LetterTemplatePath";
            ...
            return RedirectToAction("SMM1103LetterTemplate");
        }


        public ActionResult SMM1103LetterTemplateEdit(string id)
        {
        ...
        public FileResult SMM1103LetterTemplateDownload(string docid)
        {
            var query = db.B_S_LETTER_TEMPLATE.Find(docid);

            byte[] fileBytes = System.IO.File.ReadAllBytes(query.FILE_PATH+"/" + query.FILE_NAME);
            string fileName = query.FILE_NAME;
            return File(fileBytes, System.Net.Mime.MediaTypeNames.Application.Octet, fileName);
        }
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult SMM1103LetterTemplateEdit([Bind(Exclude = "")] B_S_LETTER_TEMPLATE lt, HttpPostedFileBase formFile)
        {
            try
            {
                if (formFile != null)
        ...
        public ActionResult SMM1103LetterTemplateDelete(string id)
        {
