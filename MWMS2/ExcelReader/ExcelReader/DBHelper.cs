...
namespace ExcelReader
{
    public class DBHelper
    {
        ...
        public int ExceuteNonQuery(string sql,CommandType type, OracleParameter[] ps)
        {
        ...
        public void SqlBulkCopyInsert(string tableName,DataTable dt)
        {
            try
            {
                using(SqlBulkCopy sqlRevdBulkCopy = new SqlBulkCopy(ConfigurationManager.AppSettings["ConnectionString"]))
                {
